    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <?php if (in_array($role, ['Admin', 'Doctor'])): ?>
                    <div class="col-lg-3 col-6">
                        <div class="small-box dash-stat dash-stat--medicines">
                            <div class="inner">
                                <h3 style="color: white;"><?= $medicineCount ?></h3>
                ...
                <?php if (in_array($role, ['Admin', 'Doctor'])): ?>
                    <div class="col-lg-3 col-6">
                        <div class="small-box dash-stat dash-stat--equipment">
                            <div class="inner">
                                <h3 style="color: white;"><?= $equipmentCount ?></h3>
                ...
                <?php if ($role === 'Admin'): ?>
                    <div class="col-lg-3 col-6">
                        <div class="small-box dash-stat dash-stat--users">
                            <div class="inner">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box dash-stat dash-stat--today">
                        <div class="inner">
                            <h3 style="color: white;"><?= $todayRecords ?></h3>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box dash-stat dash-stat--week">
                        <div class="inner">
                            <h3 style="color: white;"><?= $weekRecords ?></h3>
                    ...
                    <div class="card dash-card">
                        <div class="card-header border-0">
                            <h3 class="card-title d-flex align-items-center">
                                ...
                                Total Consultations Today — <?= date('F d, Y') ?>
                        ...
                        <div class="card dash-card dash-side-card w-100">
                            <div class="card-header border-0">
                                ...
                                <div class="card-tools">
                                    <!-- <a href="<?= base_url('log') ?>" class="btn btn-tool">
                                        View all
                                    </a> -->
                                </div>
                            </div>
